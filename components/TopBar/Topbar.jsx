    ...
    <div className="flex flex-row ">
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>Speed up by using Collaboration</DialogTitle>
          </DialogHeader>

          {createClicked === true && room === null ? (
