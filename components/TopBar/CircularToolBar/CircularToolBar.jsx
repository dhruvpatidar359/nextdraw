      ...
      <div id="weapon-selector-wrapper" >
        ...
        <svg height="310px" width="310px" className={styles.svg} >
          ...
          >
            ...
            <image xlinkHref="/move.svg" x="-98" y="380" height="50px" width="50px" />
          ...
          >
            ...
            <image xlinkHref="/text.svg" x="-32" y="210" height="50px" width="50px" />
          ...
          >
            <path d="M 309.99999999999994 10 A 300 300 0 0 1 522.1320343559642 97.8679656440357  L 451.4213562373095 168.57864376269046 A 200 200 0 0 0 309.99999999999994 110  z" fill={tool === "diamond" ? "#CDFADB" : "#FFFFFF"} />
            <image xlinkHref="/diamond.svg" x="320" y="200" height="55px" width="55px" />
          ...
          <g
            ...
            data-tool-name="line"
          >
            <path d="M 522.1320343559642 97.8679656440357 A 300 300 0 0 1 610 309.99999999999994  L 510 309.99999999999994 A 200 200 0 0 0 451.4213562373095 168.57864376269046  z" fill={tool === "line" ? "#CDFADB" : "#FFFFFF"} />
