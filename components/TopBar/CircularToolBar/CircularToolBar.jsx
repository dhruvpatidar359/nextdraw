import {
  changeTool,
  changeToolWheel,
} from "@/components/Redux/features/toolSlice";
        ...
        <svg height="310px" width="310px" className={styles.svg}>
          ...
          >
            <path
              ...
              fill={tool === "rectangle" ? "#CDFADB" : "#FFFFFF"}
            />
            <image
              xlinkHref="/square.svg"
              x="330"
              y="554"
              height="50px"
              width="50px"
          ...
          >
            <path
              ...
              fill={tool === "ellipse" ? "#CDFADB" : "#FFFFFF"}
            />
            <image
              xlinkHref="/circle.svg"
              x="-27"
              y="554"
              height="50px"
              width="50px"
          ...
          >
            <path
              ...
              fill={tool === "selection" ? "#CDFADB" : "#FFFFFF"}
            />
            <image
              xlinkHref="/move.svg"
              x="-100"
          ...
          >
            <path
              ...
              fill={tool === "eraser" ? "#CDFADB" : "#FFFFFF"}
            />
            <image
              xlinkHref="/eraser.svg"
              x="145"
              y="130"
              height="50px"
              width="50px"
          ...
          >
            <path
              ...
              fill={tool === "pencil" ? "#CDFADB" : "#FFFFFF"}
            />
            <image
              xlinkHref="/pencil.svg"
              x="320"
              y="190"
              height="50px"
              width="50px"
          ...
          >
            <path
              ...
              fill={tool === "diamond" ? "#CDFADB" : "#FFFFFF"}
            />
            <image
          ...
          >
            <path
              d="M 610 309.99999999999994 A 300 300 0 0 1 522.1320343559643 522.1320343559643 L 451.4213562373095 451.4213562373095 A 200 200 0 0 0 510 309.99999999999994 z"
              fill={tool === "line" ? "#CDFADB" : "#FFFFFF"}
            />
            <image
              xlinkHref="/line.svg"
              x="315"
