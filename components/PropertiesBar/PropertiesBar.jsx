...
const PropertiesBar = () => {
  ...
  const solids = ["#E2E2E2", "#9fff5b", "#70e2ff", "#cd93ff", "#09203f"];
      ...
      <ScrollArea className="h-[400px] rounded-md border p-2 bg-white">
        <Card>
          <CardContent>
            ...
            <div className="flex flex-row">
              ...
              <SimpleColorPicker
                stroke={stroke}
                setStroke={setStroke}
                setChangedByUser={setChangedByUser}
              ></SimpleColorPicker>
            </div>
          </CardContent>
          ...
          (selectedElement != null &&
            ...
            (selectedElement.type != "line") === true) ? (
            <CardContent>
            ...
            <CardContent>
              ...
              <div className="flex flex-wrap max-w-[230px] gap-2 mt-1">
                {fillStyles.map((style) => (
                  <div
                    key={style}
                    className={`border border-1 cursor-pointer active:scale-105 inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10  ${fillStyle === style ? "border-2 border-black " : null}`}
                    onClick={() => {
                      setChangedByUser(true);
                      setFillStyle(style);
                    }}
                  >
                    <p className="text-xs rounded-md ">{style}</p>
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          (selectedElement != null && selectedElement.type === "text") ? (
            <CardContent>
              ...
              <div className="flex flex-row">
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${fontSize === 24 ? "bg-[#d4d9d6]" : null} `}
                >
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${fontSize === 32 ? "bg-[#d4d9d6]" : null} `}
                >
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${fontSize === 40 ? "bg-[#d4d9d6]" : null} `}
                >
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${fontSize === 48 ? "bg-[#d4d9d6]" : null} `}
                >
          ...
          (selectedElement != null && selectedElement.type === "text") ? (
            <CardContent>
              ...
              <div className="flex flex-row">
                <Button
                  variant={"ghost"}
                  className="rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100"
                >
                  <span>
                    {" "}
                ...
                >
                  <span>
                    {" "}
                    <AlignRight className="h-4 w-4"></AlignRight>
                  </span>
                </Button>
              </div>
            </CardContent>
            ...
            <CardContent>
              ...
              <div className="flex flex-row">
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${strokeWidth === 2 ? "bg-[#d4d9d6]" : null} `}
                >
                  <span>
                    {" "}
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${strokeWidth === 4 ? "bg-[#d4d9d6]" : null} `}
                >
                  <span>
                    {" "}
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${strokeWidth === 6 ? "bg-[#d4d9d6]" : null} `}
                >
                  <span>
                    {" "}
          ...
          {(tool != "pencil" && tool != "text" && selectedElement === null) ||
          (selectedElement != null &&
            selectedElement.type != "text" &&
            selectedElement.type != "pencil") ? (
            <CardContent>
              ...
              <div className="flex flex-row">
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${JSON.stringify(strokeStyle) === JSON.stringify([]) ? "bg-[#d4d9d6]" : null} `}
                >
                  <span>
                    {" "}
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${JSON.stringify(strokeStyle) === JSON.stringify([20, 10]) ? "bg-[#d4d9d6]" : null} `}
                >
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${JSON.stringify(strokeStyle) === JSON.stringify([10, 10]) ? "bg-[#d4d9d6]" : null} `}
                >
                  <span className="h-4 w-4 flex flex-row">
            ...
            <CardContent>
              ...
              <div className="flex flex-row">
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${bowing === 2 ? "bg-[#d4d9d6]" : null} `}
                >
                  <span>
                    {" "}
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${bowing === 10 ? "bg-[#d4d9d6]" : null} `}
                >
                  <div className="flex relative">
                    ...
                    <Spline
                      className="relative right-1  h-4 w-4"
                      strokeWidth={2}
                    />
                  </div>
                </Button>
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${bowing === 14 ? "bg-[#d4d9d6]" : null} `}
                >
                  <div className="flex relative">
                    <Spline
                      className="relative left-4 h-4 w-4"
                      strokeWidth={2}
                    />
                    ...
                    />
                    <Spline
                      className="relative right-3  h-4 w-4"
                      strokeWidth={2}
                    />
                  </div>
                </Button>
            ...
            <CardContent>
              ...
              <div className="flex flex-row">
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${sharp === true ? "bg-[#d4d9d6]" : null} `}
                >
                  <div>
                    <svg
                ...
                <Button
                  ...
                  variant={"ghost"}
                  className={`rounded-md h-8 w-6 m-1 cursor-pointer active:scale-105 bg-indigo-100 ${sharp === false ? "bg-[#d4d9d6]" : null} `}
                >
                  <span>
                    {" "}
                    <MdRoundedCorner className="-scale-x-90 h-4 w-4" />
                  </span>
                </Button>
              </div>
            </CardContent>
